...
//				|| (scale > initScale && scaleFactor < 1.0f))
        if ((scale < SCALE_MAX && scaleFactor >0.2f)
                || (scale > initScale && scaleFactor < 1.0f))
		{
			/**
			 * 最大值最小值判断
...
//			}
            ...
            LogUtil.i("设置缩放比例scaleFactor： " + scaleFactor );
            LogUtil.i("detector.getFocusX()： " + detector.getFocusX());
            LogUtil.i("detector.getFocusY()： " + detector.getFocusY());
			checkBorder();
			setImageMatrix(mScaleMatrix);
		}
		return true;
	...
	public void onGlobalLayout()
	{
		if (once)
		{
            ...
            LogUtil.i("initScale: " + initScale);
            LogUtil.i("SCALE_MID: " + SCALE_MID);
            LogUtil.i("SCALE_MAX: " + SCALE_MAX);
